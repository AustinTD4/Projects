...
# Test reproduction and recombination strategies on the best combination of enemies [5,6,8]
if __name__ == '__main__':

    ##### Test weighted avg Combination #####
    filename = f'GENERALIST_Vweighted_avg'
    print(filename)
    ...
    evoman_train_set(filename, pop, runs, save=True, pop_size=100, generalist=True, set=[1,2,3,4,5,6,7,8], multiple_mode=True, differential_evolution=False, generations=50)
    ...
    ##### Test Discrete Combination #####
    filename = f'GENERALIST_Vdiscrete'
    print(filename)
    ...
    # Train new algorithms
    evoman_train_set(filename, pop, runs, save=True, multiple_mode=True, discrete=True)
    ...
    ##### Test Individual Cross #####
    filename = f'GENERALIST_Vcrossover_line'

    if not os.path.exists(f'{stat_directory}_{filename}'):
        os.makedirs(f'{stat_directory}_{filename}')

    # Train new algorithms
    evoman_train_set(filename, pop, runs, save=True, multiple_mode=True, discrete=False, crossover_line=True)
    ...
    # Train new algorithms
    evoman_train_set(filename, pop, runs, save=True, multiple_mode=True, crossover_line=False, individual_cross=True)
...
# The following experiments are longer and larger because these strategies are very different from each other and harder to compare

    ##### Test Particle Swarm Optimization #####
    filename = f'GENERALIST_Vpso'

    if not os.path.exists(f'{stat_directory}_{filename}'):
        os.makedirs(f'{stat_directory}_{filename}')

    # Train new algorithms
    evoman_train_set(filename, pop, runs, save=True, multiple_mode=True, pop_size=1000, generations=30, individual_cross=False, particle_swarm_optimization=True)
    ...
    ##### Test Individual Cross #####
    filename = f'GENERALIST_Vdifferential_evolution'

    if not os.path.exists(f'{stat_directory}_{filename}'):
        os.makedirs(f'{stat_directory}_{filename}')

    # Train new algorithms
    evoman_train_set(filename, pop, runs, save=True, multiple_mode=True, particle_swarm_optimization=False, differential_evolution=True)
    ...
    filename = f'GENERALIST_Vevolutionary_programming'

    if not os.path.exists(f'{stat_directory}_{filename}'):
        os.makedirs(f'{stat_directory}_{filename}')

    # Train new algorithms
    evoman_train_set(filename, pop, runs, save=True, multiple_mode=True, differential_evolution=False, evolutionary_programming=True)
